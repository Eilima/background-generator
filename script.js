...
//  function inputValue(hexVal1, hexVal2){
...
function gradient() {
  let colorVal = [];
  colorVal.push(color1.value);
  colorVal.push(color2.value);
  body.style.background =
    "linear-gradient(to right, " + color1.value + ", " + color2.value + ")";
  console.log(body.style.backgroundColor);
  // rbg.textContent = body.style.backgroundColor + ";";
  rbg.textContent = body.style.backgroundColor + ";";
  hex.textContent = colorVal;
}
...
function randomButton() {
  ...
  prevColor.push(hexVal1);
  prevColor.push(hexVal2);
  // Changes the pages background color to the one previously generated.
  body.style.background =
    "linear-gradient(to right, " + hexVal1 + ", " + hexVal2 + ")";
